        ...
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers(HttpMethod.GET, "/data-service-admin/developer-portal/**")
                    .hasAuthority("API_READ")
                .requestMatchers(HttpMethod.GET, "/data-service-admin/contract-governance/**")
                    .hasAuthority("CONTRACT_TEST_READ")
                .requestMatchers("/data-service-admin/contract-governance/**")
                    .hasAuthority("CONTRACT_TEST_MANAGE")
                .requestMatchers(HttpMethod.GET, "/data-service-admin/rollouts/**")
                    .hasAuthority("CANARY_READ")
                .requestMatchers("/data-service-admin/rollouts/**")
                    .hasAuthority("CANARY_MANAGE")
